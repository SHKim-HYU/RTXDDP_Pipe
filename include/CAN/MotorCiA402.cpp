...
// int Motor_CiA402::SDO_RECIEVE(void)
// {
// 	memset(&can_motor, 0, sizeof(can_frame));
// 	res = receiver(can_motor.can_id, can_motor.data, can_motor.can_dlc);
// 	if(can_motor.data[0] == 0x60)
// 		return (can_motor.can_id & 0x00F);
// 	else
// 		return 0;
// }
...
// 	motor_id = can_motor.can_id & 0x00F;
...
// void Motor_CiA402::activate_all(char *ifname)
// {
